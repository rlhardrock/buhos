...
<section id="main-container">
		...
		<div id="header-position" class="screen-large">
			...
			<div class="item-info-block">
				<div class="item-info-line one">
					...
					<?php printf( __( 'Archives of &ldquo;%s&rdquo; Category', THEMENAME ), '' .  single_cat_title( '', false ). '' ); ?>
					</span>
				</div>
			</div>
		</div>
	...
	<article id="category-list-item" class="blog-content-blog item-list-main screen-large-blog">
		<?php if(have_posts()) :
