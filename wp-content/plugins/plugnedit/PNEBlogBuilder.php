...
add_action( 'wp_enqueue_scripts', 'pne_load_pluginb_css' );
function pne_load_pluginb_css() {
wp_enqueue_style( 'pnestyles2', get_option('pnecsslink') );
}
...
add_action('wp_head','Plugnedit_cssb');
...
if (strContent.match('ICG1ADDON')){document.getElementById('PlugNeditContent').value=strContent;ProcessUpdatePlugNedit();document.forms['PlugNeditFormGet'].submit();if (document.getElementById('PlugNeditView')){document.getElementById('PlugNeditView').style.visibility='hidden'}} else{
document.getElementById('NoEditupper5').style.visibility='visible';
if (strContent=='' ){
document.getElementById('PlugNeditConfirm2').innerHTML="<span style='color:red;font-size:14px'>Support Ending For This Editor Version - Get The New Flux Live!  </span> Please use the new Flux Live Editor for new pages, it is almost exacty like the Fast version but works on your own site in your theme and has better options. <br><br> You can download the new Commercial Version Flux Editor at: <a href='http://www.binpress.com/app/flux-live-editor-/3360' style='color:red'>BinPress - Flux Live Advanced</a>.<br><br> Free Flux Lite Version At: <a href='http://javascripttech.com/currentbuildfree/' style='color:red'> Flux Live Lite Free</a><br><br>Note: Leave old plugin installed if you have pages created in old editor.  ";
document.getElementById('NoEditupper5').style.height=300+'px';
document.getElementById('PNE-page-import').value=" Continue Anyway ";
document.getElementById('PNE-page-import').setAttribute("onclick","document.getElementById('PlugNeditContent').value=strContent;ProcessUpdatePlugNedit();document.forms['PlugNeditFormGet'].submit();if (document.getElementById('PlugNeditView')){document.getElementById('PlugNeditView').style.visibility='hidden';}");
}
if (strContent.match('PlugNeditFluxEditor')){
document.getElementById('PlugNeditConfirm2').innerHTML="This is a flux page and is not compatible with the older fast editor, please load this page from the top admin bar under the Flux menu.";
document.getElementById('PNE-page-import').style.display='none';
document.getElementById('NoEditupper5').style.height=250+'px';
