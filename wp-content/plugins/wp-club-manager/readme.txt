...
* Fix - Actually fixed auto stats updates for players this time!
* Tweak - Improved player query performance
* Tweak - Added some settings to status report for better debugging
